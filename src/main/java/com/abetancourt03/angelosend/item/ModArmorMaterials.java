...
public enum ModArmorMaterials implements ArmorMaterial {
    ENDERITE("enderite", 50, new int[] { 5, 10, 8, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
            1f, 0.2f, () -> Ingredient.ofItems(ModItems.ENDERITE_INGOT));
    ...
    public String getName() {
        return AngelosEnd.MOD_ID + ":" + this.name;
    }
